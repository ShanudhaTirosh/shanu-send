    ...
    <div className="glass p-3.5 rounded-2xl space-y-2 border border-zinc-800 bg-zinc-900/40 backdrop-blur-md">
      ...
      <div className="grid grid-cols-4 gap-2">
        {shortcuts.map(s => (
          <div
            key={s.key}
            className="group relative flex flex-col items-center justify-center bg-zinc-950/30 p-1.5 rounded-lg border border-transparent hover:border-zinc-700 transition-all cursor-help"
          >
