...
export default function ThemedModal({
  ...
  return (
    ...
    >
      ...
      <div
        className={`relative w-full max-w-md bg-zinc-950/90 border ${current.border} rounded-3xl shadow-[0_20px_60px_-15px_rgba(0,0,0,0.7)] overflow-hidden animate-in zoom-in-95 fade-in duration-300 flex flex-col backdrop-blur-2xl`}
      >
        ...
        <div
          className="absolute top-0 left-0 right-0 h-[2px] bg-gradient-to-r from-transparent via-current to-transparent opacity-40"
        ...
        <div className="p-8 pb-6 flex flex-col items-center text-center pt-12">
          ...
          <h3 className="text-xl font-black italic uppercase tracking-tighter text-white mb-3">{title}</h3>
          <p className="text-zinc-400 text-sm font-medium leading-relaxed max-w-[280px]">{message}</p>
        </div>
