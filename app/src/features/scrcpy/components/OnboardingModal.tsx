          ...
          <div className="hidden md:flex md:w-1/3 bg-primary/10 border-r border-zinc-800 p-8 flex-col justify-between relative overflow-hidden">
            ...
            <div className="relative z-10 space-y-4">
              <div className="p-4 rounded-2xl bg-black/40 border border-white/5 backdrop-blur-sm">
                <p className="text-[10px] text-zinc-400 leading-relaxed font-medium">{t('onboarding.introQuote')}</p>
              </div>
            </div>
          </div>
            ...
            <div className="space-y-8">
              <div className="flex gap-4 group">
                ...
                <div className="flex-1 pt-1">
                  ...
                  <p className="text-xs text-zinc-500 leading-relaxed font-medium mb-4">{t('onboarding.binariesDescription')}</p>
                    ...
                    <div className="space-y-4">
                      ...
                      <div className="pt-6 border-t border-zinc-900">
                        ...
                        <p className="text-[10px] text-zinc-600 mb-3 leading-loose">
                          {t('onboarding.manualSetupBefore')} <span className="text-zinc-400 font-bold">{t('onboarding.manualSetupAdministrator')}</span>
